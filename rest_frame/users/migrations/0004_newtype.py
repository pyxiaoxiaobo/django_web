# Generated by Django 3.0 on 2019-12-16 01:38
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('users', '0003_type_type2_type3_type4'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_category', models.ForeignKey(blank=True, help_text='父类别', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sub_cat', to='users.NewType', verbose_name='父类目录')),
            ],
            options={
                'verbose_name': '商品类别',
